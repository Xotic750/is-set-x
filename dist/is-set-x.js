...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return isSet; });
...
if (typeof Set === 'function') {
  ...
  if (is_set_x_esm_descriptor && typeof is_set_x_esm_descriptor.get === 'function') {
    var is_set_x_esm_res = attempt(function () {
    ...
    if (is_set_x_esm_res.threw === false && isObjectLike(is_set_x_esm_res.value)) {
      is_set_x_esm_res = attempt.call(is_set_x_esm_res.value, is_set_x_esm_descriptor.get);

      if (is_set_x_esm_res.threw === false && isLength(is_set_x_esm_res.value)) {
...
//# sourceMappingURL=is-set-x.js.map