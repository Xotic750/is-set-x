 ...
 * @module is-set-x
 */
"use strict";var attempt,isObjectLike,isLength,getSize,isFalsey=_dereq_("is-falsey-x");if("function"==typeof Set){var descriptor=_dereq_("object-get-own-property-descriptor-x")(Set.prototype,"size");if(descriptor&&"function"==typeof descriptor.get){attempt=_dereq_("attempt-x"),isObjectLike=_dereq_("is-object-like-x");var res=attempt(function(){return new Set});!1===res.threw&&isObjectLike(res.value)&&(isLength=_dereq_("is-length-x"),!1===(res=attempt.call(res.value,descriptor.get)).threw&&isLength(res.value)&&(getSize=descriptor.get))}}module.exports=function isSet(object){if(isFalsey(getSize)||!1===isObjectLike(object))return!1;var result=attempt.call(object,getSize);return!1===result.threw&&isLength(result.value)}},{"attempt-x":3,"is-falsey-x":9,"is-length-x":14,"is-object-like-x":17,"object-get-own-property-descriptor-x":27}],2:[function(_dereq_,module,exports){/**
